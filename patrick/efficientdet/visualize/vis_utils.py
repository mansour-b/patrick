...
from patrick.efficientdet.visualize import shape_utils
from patrick.efficientdet.visualize import standard_fields as fields
...
def draw_bounding_boxes_on_image_tensors(
    ...
    def draw_boxes(image_and_detections):
        ...
        image_with_boxes = tf.numpy_function(
...
class EvalMetricOpsVisualization(six.with_metaclass(abc.ABCMeta, object)):
    ...
    def get_estimator_eval_metric_ops(self, eval_dict):
        ...
        if tf.executing_eagerly():
            ...
            image_tensors = tf.numpy_function(
