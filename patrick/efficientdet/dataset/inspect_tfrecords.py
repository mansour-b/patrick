...
from patrick.efficientdet import dataloader, hparams_config, utils
from patrick.efficientdet.visualize import vis_utils
    ...
    def visualize(self):
        ...
        for i, zip_data in enumerate(zip(gt_data, images, scales)):
            ...
            if boxes.shape[0] > 0:
                ...
                try:
                    category_index = {
                        idx: {"id": idx, "name": self.cls_to_label[idx]}
